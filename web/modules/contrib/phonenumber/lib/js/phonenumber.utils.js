...
var factoryOutput = (() => {
  ...
  var Iti = class {
    ...
    //*  PRIVATE METHODS
    //********************
    //* Prepare all of the country data, including onlyCountries, excludeCountries, countryOrder and preferredCountries options.
    _processCountryData() {
    ...
    _setCountry(iso2) {
      ...
      if (this.options.allowDropdown && !countrySearch) {
