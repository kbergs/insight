...
var factoryOutput = (() => {
  ...
  var Iti = class {
    ...
    //*  PRIVATE METHODS
    //********************
    //* Prepare all of the country data, including onlyCountries, excludeCountries, preferredCountries and countryOrder options.
    _processCountryData() {
    ...
    _generateMarkup() {
      ...
      if (allowDropdown || showFlags) {
        ...
        if (allowDropdown) {
          ...
          if (preferredCountries && preferredCountries.length && !countrySearch) {
            this._appendListItems(preferredCountries, "iti__preferred", true);
            createEl(
              "li",
              {
                class: "iti__divider",
    ...
    _updateValFromNumber(fullNumber) {
      ...
      if (this.options.removeStartZero) {
    ...
    _setCountry(iso2) {
      const { separateDialCode, showFlags, countrySearch, i18n } = this.options;
